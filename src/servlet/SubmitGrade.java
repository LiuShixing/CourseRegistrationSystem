...
public class SubmitGrade extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		while(pIds.hasMoreElements()){
		    ...
		    String id=(String)pIds.nextElement();
		    if(id.equals("couId") || id.equals("proId"))
		    	continue;
		    String grade=request.getParameter(id);
		    int stuId = Integer.parseInt(id);
		    
		    System.out.println(""+couid+":"+proid);
		    System.out.println(""+stuId+":"+grade);
		    dbManager.updateStudentGrade(couid, proid, stuId, grade);
		}
		response.sendRedirect(request.getContextPath()
				+ "/Professor/submitGrade.jsp?msg=submit grade successfully");
	}
