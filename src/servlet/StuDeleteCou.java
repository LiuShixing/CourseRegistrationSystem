...
public class StuDeleteCou extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		if (dbManager.deleteTake(couid, proid, stuid))
		{
			response.sendRedirect(request.getContextPath()
					+ "/Student/update.jsp?msg=delete cource successfully");
		} else
		{
			response.sendRedirect(request.getContextPath()
					+ "/Student/update.jsp?msg=delete cource failure");
		}
	}
